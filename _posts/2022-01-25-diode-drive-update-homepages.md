---
layout: post
title: Diode Collab Feature - Home Pages
...
In version 1.3.11 (2021-12-28) and later, Diode Collab supports viewing Markdown (.md file extension) contents. Markdown allows you to add simple formatting elements to text documents (check out the <a href="https://app.docs.diode.io/docs/features/markdown-editing-basics/">Diode Collab Markdown Editing Basics guide</a>), while still maintaining readability of the text itself. 
